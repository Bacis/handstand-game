...
export const ACHIEVEMENTS = [
  ...
  // Duel achievements — fire via recordDuel, gated by the 'duel_complete' event.
  {
    key: 'duel_first',
    name: 'Thrown Gauntlet',
    description: 'Finish your first duel.',
    icon: '🤺',
    glyph: 'GiCrossedSwords',
    tier: 'bronze',
    check: (c) => c.counters.duels_played >= 1,
    event: 'duel_complete',
  },
  {
    key: 'duel_win_1',
    ...
    glyph: 'GiTrophyCup',
    tier: 'bronze',
    check: (c) => c.counters.duels_won >= 1,
    event: 'duel_complete',
  },
  {
    key: 'duel_win_10',
    ...
    glyph: 'GiColosseum',
    tier: 'silver',
    check: (c) => c.counters.duels_won >= 10,
    event: 'duel_complete',
  },
  {
    key: 'duel_win_50',
    ...
    glyph: 'GiCrown',
    tier: 'gold',
    check: (c) => c.counters.duels_won >= 50,
    event: 'duel_complete',
  },
  {
    key: 'duel_streak_3',
    name: 'Three in a Row',
    description: 'Win three duels back to back.',
    icon: '🔥',
    glyph: 'GiFlame',
    tier: 'silver',
    check: (c) => c.counters.current_win_streak >= 3,
    event: 'duel_complete',
  },
  {
    key: 'duel_streak_10',
    ...
    icon: '⚡',
    glyph: 'GiLightningStorm',
    tier: 'gold',
    check: (c) => c.counters.current_win_streak >= 10,
    event: 'duel_complete',
  },
  {
    key: 'duel_david',
    name: 'David',
    description: 'Beat a registered opponent as a guest.',
    icon: '🏹',
    glyph: 'GiSlingshot',
    tier: 'silver',
    check: (c) => c.counters.david_goliaths >= 1,
    event: 'duel_complete',
  },
];
